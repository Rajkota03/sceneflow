    ...
    <footer className="bg-slate-50 border-t border-slate-200">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-semibold text-lg mb-4 text-slate-900">Links</h3>
          ...
          <div>
            <h3 className="font-semibold text-lg mb-4 text-slate-900">Support</h3>
            <ul className="space-y-3">
        ...
        <div className="border-t border-slate-200 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-500 text-sm">© {currentYear} Scene Flow. All rights reserved.</p>
