...
import { ChevronRight, ChevronLeft, Tag as TagIcon } from 'lucide-react';
import { cn } from '@/lib/utils';
import { convertLibToScriptTypes } from '@/utils/typeAdapter';
...
const TagManager: React.FC<TagManagerProps> = ({ 
  ...
  try {
    const { availableTags, actCounts } = useActCounts(convertLibToScriptTypes(scriptContent));
