...
export interface Beat {
  ...
  title: string;
  description: string;
  timePosition: number; // Percentage position (0-100)
}
...
export interface Act {
  ...
  title: string;
  colorHex: string;
  startPosition: number; // Percentage position (0-100)
  endPosition: number; // Percentage position (0-100)
  beats: Beat[];
}
...
export function createDefaultStructure(projectId?: string, projectTitle: string = "Untitled Project"): Structure {
  return {
    id: uuidv4(),
    projectId,
    projectTitle,
