...
import { ScenePage } from './scene/[sceneId]';
...
const Dashboard = () => {
  ...
  // Check if we're on a sub-route and render the appropriate component
  const isSubRoute = location.pathname !== '/dashboard';

  return (
    <Routes>
      <Route path="/editor/:projectId" element={<Editor />} />
      <Route path="/structure/:structureId" element={<StructureEditor />} />
          ...
          <div className="flex-1 overflow-auto">
            <div className="mx-auto max-w-7xl pt-20 pb-6 px-4 sm:px-6 lg:px-8">
              ...
              <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <Button 
                  onClick={() => navigate('/dashboard/beat-board')}
